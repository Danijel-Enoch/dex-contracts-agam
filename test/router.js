...
//         const factory = await PancakeFactory.deploy(alice);
//         pancakeFactory = await factory.deployed();
...
//         const router = await PancakeRouter.deploy(pancakeFactory.address, wrappedBNB.address, { from: alice });
//         pancakeRouter = await router.deployed();

//         // Deploy ERC20s
//         const MockERC20 = await hre.ethers.getContractFactory("MockERC20");
//         tokenA = await MockERC20.deploy("Token A", "TA", parseEther("10000000"), { from: alice });
//         tokenC = awaitMockERC20.deploy("Token C", "TC", parseEther("10000000"), { from: alice });
